...
,coalesce(pp.image_url, pa.image_url) politic_party_image
,rd.candidate_id
,rd.number_box 
,c.box_number 
,c."name" 
...
inner join voting_center vc 
  ...
  inner join ballot_detail bd 
       on (bd.politic_party_id  = rd.politic_party_id 
