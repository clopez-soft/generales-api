...
export class CandidateService {
  ...
  findByPartyAndLevel(politic_party_id: string, level: ELECTORAL_LEVEL) {
    const res = this.candidateRepo
      .createQueryBuilder("candidate")
      .leftJoinAndSelect("candidate.politic_party", "politic_party");
    ...
    res
      .where("candidate.politic_party_id = :politic_party_id")
      .andWhere("candidate.level = :level")
      .setParameters({
        politic_party_id: politic_party_id,
        level: level,
      })
